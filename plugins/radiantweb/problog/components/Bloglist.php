    ...
    public function defineProperties()
    {
        ...
        return [
            ...
            'filter_type' => [
                ...
                'default'     => 'none',
                'type'        => 'dropdown',
                'options'     => ['none'=>'none','category'=>'Category','tag'=>'Tag','author'=>'Author','cannonical'=>'Cannonical','popular'=>'Popular','trending'=>'Trending'],
    ...
    protected function loadPosts()
    {
        ...
        if($this->param('filter')){
            ...
            if($type == 'category'){
                ...
                $category = CategoryModel::whereRaw("slug = '$slug'")->first();
                if($category){
                    $catID = $category->id;
                }else{
                    $catID = '#';
